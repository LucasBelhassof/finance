...
function FeedbackAlert({ feedback }: { feedback: FeedbackState }) {
  ...
  return (
    <Alert
      ...
      className={
        feedback.type === "success" ? "border-income/30 bg-income/10 text-foreground [&>svg]:text-income" : undefined
      }
    >
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Os dois campos precisam ser idênticos para liberar a alteração.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription>
                                Use pelo menos 8 caracteres e evite repetir a senha atual.
                              </FormDescription>
                              <FormMessage />
                            </FormItem>
                          )}
                ...
                <form className="mt-4 space-y-5" onSubmit={handleContactSubmit}>
                  <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_320px]">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            O numero e normalizado ao salvar e armazenado sem caracteres extras.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <div className="rounded-xl border border-dashed border-border/50 bg-secondary/20 p-4">
                      ...
                      <p className="mt-2 text-sm text-foreground">
                        A interface está pronta para um fluxo por código, mas o backend ainda não expõe essa
                        verificação.
                      </p>
                      <Button
                        type="button"
              ...
              <div className="mt-4 grid gap-4">
                <div className="flex items-start justify-between gap-4 rounded-xl border border-border/40 bg-secondary/20 p-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Permite avisos relevantes sobre conta, produto e automações futuras.
                    </p>
                  </div>
                  <Switch
                ...
                <div className="flex items-start justify-between gap-4 rounded-xl border border-border/40 bg-secondary/20 p-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Prepara a interface para um resumo de movimentações e alertas semanais.
                    </p>
                  </div>
                  <Switch
                ...
                <div className="flex items-start justify-between gap-4 rounded-xl border border-border/40 bg-secondary/20 p-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Deixa a conta preparada para futuros lembretes de fatura e vencimentos.
                    </p>
                  </div>
                  <Switch
                ...
                <div className="flex items-start justify-between gap-4 rounded-xl border border-border/40 bg-secondary/20 p-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Reserva uma preferencia de exibicao para valores resumidos na interface.
                    </p>
                  </div>
                  <Switch
