    ...
    <AppShell title="Insights" description="Area temporariamente desabilitada">
      ...
      <div data-tour-id="insights-recommendations" className="glass-card p-5">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted-foreground">
          ...
          fechada para gerar insights confiaveis. Enquanto isso, o chat usa os dados financeiros reais do usuário para
          analisar gastos, montar planos e orientar próximos passos.
        </p>
        <div className="mt-5">
          <Button asChild>
