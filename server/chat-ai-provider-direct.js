...
function buildSystemInstruction(payload) {
  ...
  if (payload.task === "plan_draft") {
    return [
      ...
      'Formato obrigatorio: {"title":"...","description":"...","goal":{"type":"items|transaction_sum","source":"ai","targetAmount":null,"transactionType":"expense|income","targetModel":"category|investment_box","categoryIds":[],"investmentBoxIds":[],"investmentBoxes":[],"startDate":null,"endDate":null},"items":[{"title":"...","description":"...","status":"todo"}],"clarifications":[]}',
      "Crie de 3 a 7 itens objetivos e acionaveis.",
      'Use status sempre como "todo".',
      'Use goal.type "transaction_sum" quando houver meta financeira clara. Use "items" quando o melhor progresso for por tarefas concluidas.',
      "Para meta por categorias, preencha targetAmount, transactionType, categoryIds quando aplicavel, startDate e endDate.",
      'Para meta por caixinha, use targetModel "investment_box", preencha targetAmount e investmentBoxIds com uma ou mais caixinhas ativas de context.investmentBoxes quando o usuario indicar.',
      "Se o usuario pedir uma nova caixinha, retorne uma sugestao em investmentBoxes; ela sera criada apenas na confirmacao do plano.",
      "Quando usar categoryIds, use somente ids existentes em context.categories.",
      "Quando faltar data final e ela for necessaria para meta por categorias, adicione uma pergunta obrigatoria em clarifications.",
      "Para caixinhas, endDate pode ser null quando nao houver prazo definido.",
